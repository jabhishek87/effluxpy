...
import effluxpy.widget as effluxpy_widget
import effluxpy.manager as effluxpy_manager

from effluxpy.tests.deprecated.plugin import player as player
...
def register_plugin(manager):
    widget_class = effluxpy_widget.WidgetBase
...
class TestIntegrationBase(TestPlayerBase):
    ...
    manager_module = effluxpy_manager
    widget_module = effluxpy_widget
    file_module = effluxpy_file
...
class TestIntegration(TestIntegrationBase):
    def test_register_plugin(self):
        ...
        self.app.config.update(
            ...
            plugin_namespaces=('effluxpy.tests.deprecated.plugin',)
        )
