.. effluxpy documentation master file, created by
   sphinx-quickstart on Thu Nov 17 11:54:15 2016.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to effluxpy's documentation!
====================================

Welcome to effluxpy's documentation. It's recommended to start reading both
:ref:`quickstart` and, specifically :ref:`quickstart-installation`, while more
detailed tutorials about integrating :mod:`effluxpy` as module or plugin
development are also available.

effluxpy has few dependencies: `Flask`_ and `Scandir`_. `Flask`_ is an awesome
